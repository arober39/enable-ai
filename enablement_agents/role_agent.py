...
def _build_role_prompt(role: Role) -> str:
    ...
    return (
        ...
        "Your domain knowledge — the space of capabilities this function "
        "could enable with AI, the integration patterns that typically work, "
        "the failure modes specific to this domain — is the body of this "
        "prompt. Ground your reasoning against it. Do not freelance "
        "capability lists from memory.\n\n"
        "## Your tools\n\n"
        ...
        "2. Re-read the domain knowledge in this prompt. Ground every "
        "capability assessment against it.\n"
        ...
        "5. Compare the declared stack against the capabilities in your "
        "domain knowledge. For each capability, determine: covered, partial, "
        "gap, or redundant. Cite the tools involved.\n"
        "6. Translate the findings into recommendations. Every "
